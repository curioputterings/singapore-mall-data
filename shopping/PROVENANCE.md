...
| --- | ---: | ---: | ---: | ---: | --- |
| **Retail** | 5,826 | 994 (17%) | 888 (15%) | 3,944 (68%) | **17%–85%** |
| **F&B** | 3,332 | 690 (21%) | 690 (21%) | 1,951 (59%) | **21%–79%** |
| **All** | 9,158 | 1,684 (18%) | 1,578 (17%) | 5,895 (64%) | **18%–83%** |
...
_Per-brand labels: `data/provenance.csv`._
